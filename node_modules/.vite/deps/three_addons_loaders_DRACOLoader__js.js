import { Br as LinearSRGBColorSpace, J as BufferGeometry, To as SRGBColorSpace, Ur as Loader, Wr as LoaderUtils, ir as InterleavedBufferAttribute, lt as ColorManagement, q as BufferAttribute, rr as InterleavedBuffer, st as Color, vn as FileLoader } from "./three.module-L0vMa_aS.js";
//#region node_modules/three/examples/jsm/loaders/DRACOLoader.js
var _taskCache = /* @__PURE__ */ new WeakMap();
var WASM_BIN_URL = new URL("../../three/examples/jsm/libs/draco/draco_decoder.wasm", import.meta.url).toString();
var WASM_JS_URL = new URL("../../three/examples/jsm/libs/draco/draco_wasm_wrapper.js", import.meta.url).toString();
var JS_URL = new URL("../../three/examples/jsm/libs/draco/draco_decoder.js", import.meta.url).toString();
var DRACO_GLTF_CONFIG = {
	js: new URL("../../three/examples/jsm/libs/draco/gltf/draco_wasm_wrapper.js", import.meta.url).toString(),
	wasm: new URL("../../three/examples/jsm/libs/draco/gltf/draco_decoder.wasm", import.meta.url).toString()
};
/**
...
var DRACOLoader = class extends Loader {
	...
	*/
	...
	_initDecoder() {
		...
		const { decoderPaths } = this;
		if (useJS) {
			if (decoderPaths.dep_js === null) throw new Error("THREE.DRACOLoader: WebAssembly is required when using a custom decoder paths.");
