...
function getAudioManager() {
  if (!_instance3) _instance3 = new AudioManager();
  return _instance3;
}
...
function getTweenManager() {
  if (!_instance4) _instance4 = new TweenManager();
  return _instance4;
}
...
function getParticleManager() {
  if (!_instance5) _instance5 = new ParticleManager();
  return _instance5;
}
...
function GameLoopTick() {
  (0, import_fiber.useFrame)((_, rawDelta) => {
...
function InputFlush() {
  const gl = (0, import_fiber.useThree)((s) => s.gl);
  (0, import_react2.useEffect)(() => {
...
function Game({
  ...
  const is2D = mode === "2d";
  const contextValue = (0, import_react2.useMemo)(() => ({ mode }), [mode]);
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_fiber.Canvas, { shadows: !is2D, ...canvasProps, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(GameContext.Provider, { value: contextValue, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GameLoopTick, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputFlush, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollisionFlush, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioFlush, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TweenFlush, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ParticleFlush, {}),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ambientLight", { intensity: is2D ? 1 : 0.4, ...ambientLightProps }),
    !is2D && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_drei.Sky, { sunPosition: [100, 20, 100], ...skyProps }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_drei.Environment, { preset: "sunset", background: true, ...environmentProps })
    ] }),
    children
  ] }) });
}
...
function useCamera(options = {}) {
  ...
  const _targetPos = (0, import_react3.useRef)(new import_three4.Vector3());
  const _desiredPos = (0, import_react3.useRef)(new import_three4.Vector3());
  const _lookAtPos = (0, import_react3.useRef)(new import_three4.Vector3());
  const shakeRef = (0, import_react3.useRef)({ active: false, intensity: 0, remaining: 0 });
  ...
  const shake = (0, import_react3.useCallback)((intensity = 0.3, duration = 0.3) => {
    shakeRef.current = { active: true, intensity, remaining: duration };
  }, []);
  const moveTo = (0, import_react3.useCallback)(
    (position, duration = 1) => {
      transitionRef.current = {
        active: true,
        from: camera.position.clone(),
        to: new import_three4.Vector3(...position),
        duration,
        elapsed: 0
      };
    },
  ...
  const lookAtFn = (0, import_react3.useCallback)(
    (target) => {
      camera.lookAt(new import_three4.Vector3(...target));
    },
    [camera]
  );
...
function OrbitFollow({ follow }) {
  const controlsRef = (0, import_react4.useRef)(null);
  const _targetPos = (0, import_react4.useRef)(new import_three5.Vector3());
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_drei2.OrbitControls, { ref: controlsRef, enableZoom: true });
}
var Camera = (0, import_react4.forwardRef)(
  ({
    type = "perspective",
    controls = "none",
    follow,
    ...
    const api = useCamera({ follow: useOrbitFollow ? void 0 : follow });
    (0, import_react4.useEffect)(() => {
      onReady?.(api);
    }, [onReady, api]);
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      type === "perspective" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        import_drei2.PerspectiveCamera,
        {
          ref,
          makeDefault: true,
          position: [0, 5, 10],
        ...
        import_drei2.OrthographicCamera,
        {
          ref,
          makeDefault: true,
          position: [0, 0, 100],
      ...
      controls === "orbit" && (useOrbitFollow ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(OrbitFollow, { follow }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_drei2.OrbitControls, { enableZoom: true, ...orbitControlsProps })),
      controls === "map" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_drei2.MapControls, { enableZoom: true, ...mapControlsProps }),
      controls === "pointerlock" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_drei2.PointerLockControls, { ...pointerLockControlsProps })
    ] });
  }
);
...
var _rapierModules = null;
var _rapierLoadPromise = null;
var _rapierLoadFailed = false;
function loadRapier() {
  ...
  _rapierLoadPromise = import("@react-three/rapier").then((mod) => {
    _rapierModules = {
      Physics: mod.Physics,
...
function useRapierModules() {
  const [modules, setModules] = (0, import_react5.useState)(_rapierModules);
...
var PhysicsContext = (0, import_react5.createContext)(null);
function usePhysicsContext() {
  return (0, import_react5.useContext)(PhysicsContext);
}
function PhysicsGate({ config, mode, children }) {
  ...
  if (!modules) {
    if (_rapierLoadFailed) {
      console.warn(
        "[@carverjs/core] World has a `physics` prop but @react-three/rapier is not installed. Install it with: pnpm add @react-three/rapier"
      );
    }
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PhysicsContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react5.Suspense, { fallback: null, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    Physics,
    {
      gravity,
      timeStep: timestep,
...
var RigidBodyRefContext = (0, import_react5.createContext)(null);
function mapColliderType(collider) {
  if (!collider || collider === "auto") return "cuboid";
  if (collider === "convexHull") return "hull";
  return collider;
}
function buildCollisionHandler(callback, isSensor) {
...
function PhysicsBodyWrapper({
  ...
  const rigidBodyRef = (0, import_react5.useRef)(null);
  ...
  if (physics.mass !== void 0) rigidBodyProps.mass = physics.mass;
  if (physics.restitution !== void 0) rigidBodyProps.restitution = physics.restitution;
  if (physics.friction !== void 0) rigidBodyProps.friction = physics.friction;
  ...
  if (physics.gravityScale !== void 0) rigidBodyProps.gravityScale = physics.gravityScale;
  if (physics.linearDamping !== void 0) rigidBodyProps.linearDamping = physics.linearDamping;
  if (physics.angularDamping !== void 0) rigidBodyProps.angularDamping = physics.angularDamping;
  if (physics.ccd !== void 0) rigidBodyProps.ccd = physics.ccd;
  ...
  const onIntersectionEnter = sensor ? buildCollisionHandler(physics.onCollisionEnter, true) : void 0;
  const onIntersectionExit = sensor ? buildCollisionHandler(physics.onCollisionExit, true) : void 0;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RigidBody, { ref: rigidBodyRef, ...rigidBodyProps, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(RigidBodyRefContext.Provider, { value: rigidBodyRef, children }) });
}
...
function World({
  ...
  const { mode } = useGameContext();
  const is2D = mode === "2d";
  const hasCustomCamera = import_react6.Children.toArray(children).some(
    (child) => (0, import_react6.isValidElement)(child) && child.type === Camera
  );
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("group", { visible: active, children: [
    !hasCustomCamera && (is2D ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      import_drei3.PerspectiveCamera,
      {
        makeDefault: true,
        position: [0, 5, 10],
        fov: 75,
    ...
    !is2D && !hasCustomCamera && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_drei3.OrbitControls, { enableZoom: true, ...orbitControlsProps }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PhysicsGate, { config: physics, mode, children })
  ] });
}

// src/components/Actor.tsx
...
function useAnimation(clips, options = {}) {
  ...
  const { ref, mixer, actions, names } = (0, import_drei4.useAnimations)(clips);
  const previousAction = (0, import_react7.useRef)(null);
  (0, import_react7.useEffect)(() => {
    ...
    action.reset();
    action.setLoop(loop ? import_three6.LoopRepeat : import_three6.LoopOnce, loop ? Infinity : 1);
  ...
  const stopAll = (0, import_react7.useCallback)(() => {
    mixer.stopAllAction();
    previousAction.current = null;
  }, [mixer]);
  const crossFadeTo = (0, import_react7.useCallback)(
    (name, duration = 0.3) => {
      const action = actions[name];
      if (!action) return;
      if (previousAction.current) {
...
function getActorRegistry() {
  if (!_instance6) _instance6 = new ActorRegistry();
  return _instance6;
}

// src/components/Actor.tsx
var import_jsx_runtime5 = require("react/jsx-runtime");
var DEFAULT_GEOMETRY_ARGS = {
  box: [1, 1, 1],
  sphere: [0.5, 32, 32],
...
function ModelRenderer({
  ...
  const { scene, animations } = (0, import_drei5.useGLTF)(src, useDraco, useMeshopt);
  const clone = (0, import_react8.useMemo)(() => {
    return animations.length > 0 ? import_three_stdlib.SkeletonUtils.clone(scene) : scene.clone(true);
  }, [scene, animations]);
  ...
  (0, import_react8.useEffect)(() => {
    clone.traverse((child) => {
      if (child instanceof import_three7.Mesh) {
        child.castShadow = castShadow ?? false;
        child.receiveShadow = receiveShadow ?? false;
      }
    });
  }, [clone, castShadow, receiveShadow]);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("primitive", { object: clone, ref });
}
function SpriteRenderer({
  ...
  if (atlasUrl && spriteAnimation) {
    const content = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      import_drei5.SpriteAnimator,
      {
        textureImageURL: src,
...
function AnimatedGridSprite({
  ...
  const texture = (0, import_drei5.useTexture)(src);
  const matRef = (0, import_react8.useRef)(null);
  const frameRef = (0, import_react8.useRef)(startFrame);
  const elapsedRef = (0, import_react8.useRef)(0);
  ...
  (0, import_react8.useEffect)(() => {
    texture.wrapS = import_three7.RepeatWrapping;
    texture.wrapT = import_three7.RepeatWrapping;
    const repeatX = 1 / grid.cols;
    const repeatY = 1 / grid.rows;
    texture.repeat.set(flipX ? -repeatX : repeatX, repeatY);
    texture.needsUpdate = true;
  }, [texture, grid, flipX]);
  (0, import_fiber4.useFrame)((_, delta) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("sprite", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("spriteMaterial", { ref: matRef, map: texture }) });
}
function StaticSprite({
  ...
  const texture = (0, import_drei5.useTexture)(src);
  const content = /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("sprite", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("spriteMaterial", { map: texture }) });
  if (billboard) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      import_drei5.Billboard,
      {
...
function PrimitiveRenderer({
  ...
  const geometryElement = {
    box: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("boxGeometry", { args }),
    sphere: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("sphereGeometry", { args }),
    cylinder: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("cylinderGeometry", { args }),
    cone: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("coneGeometry", { args }),
    torus: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("torusGeometry", { args }),
    plane: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("planeGeometry", { args }),
    circle: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("circleGeometry", { args }),
    capsule: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("capsuleGeometry", { args }),
    ring: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("ringGeometry", { args })
  }[shape ?? "box"];
  const sharedMaterialProps = { color, wireframe, ...materialProps };
  const materialElement = {
    standard: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meshStandardMaterial", { ...sharedMaterialProps }),
    basic: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meshBasicMaterial", { ...sharedMaterialProps }),
    phong: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meshPhongMaterial", { ...sharedMaterialProps }),
    lambert: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meshLambertMaterial", { ...sharedMaterialProps }),
    toon: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("meshToonMaterial", { ...sharedMaterialProps })
  }[materialType ?? "standard"];
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("mesh", { castShadow, receiveShadow, children: [
    geometryElement,
    materialElement
  ] });
}
var Actor = (0, import_react8.forwardRef)((props, ref) => {
  const {
    type,
    name,
    position,
  ...
  const setRefs = (0, import_react8.useCallback)((node) => {
  ...
  (0, import_react8.useEffect)(() => {
    ...
    registry.register(name, {
      ...
      rigidBody: void 0,
      // Will be set by PhysicsBodyWrapper
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PhysicsBodyWrapper, { physics, name, userData, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "group",
    {
      ref: setRefs,
      name,
      position,
      rotation,
      scale: scale ?? (size != null ? [size, size, size] : void 0),
      visible,
      userData,
      renderOrder,
      onClick,
      ...
      onWheel,
      children: [
        type === "model" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          ModelRenderer,
          {
            src: props.src,
            ...
            animationLoop: props.animationLoop,
            castShadow,
            receiveShadow
          }
        ),
        type === "sprite" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          SpriteRenderer,
          {
            src: props.src,
            atlasUrl: props.atlasUrl,
            billboard: props.billboard,
            billboardLockX: props.billboardLockX,
            billboardLockY: props.billboardLockY,
            billboardLockZ: props.billboardLockZ,
            spriteAnimation: props.spriteAnimation
          }
        ),
        type === "primitive" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          PrimitiveRenderer,
          {
            shape: props.shape,
            geometryArgs: props.geometryArgs,
...
// src/components/AudioListener.tsx
var import_react9 = require("react");
var import_fiber5 = require("@react-three/fiber");
function AudioListener({ listenerRef }) {
...
function SceneTransitionFlush() {
  (0, import_fiber6.useFrame)((_, rawDelta) => {
...
function TransitionOverlay() {
  ...
  const materialRef = (0, import_react10.useRef)(null);
  const colorVec = (0, import_react10.useMemo)(() => {
    return new import_three8.Color(config.color ?? "#000000");
  }, [config.color]);
  (0, import_fiber6.useFrame)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("mesh", { renderOrder: 9999, frustumCulled: false, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("planeGeometry", { args: [2, 2] }),
...
var SceneErrorBoundary = class extends import_react10.Component {
  constructor() {
    super(...arguments);
...
var _lazyCache = /* @__PURE__ */ new Map();
function SceneContent({ entry }) {
  const { config, data } = entry;
  const SceneComponent = (0, import_react10.useMemo)(() => {
    if (config.component) return config.component;
    if (config.loader) {
      let cached = _lazyCache.get(config.name);
      if (!cached) {
        cached = (0, import_react10.lazy)(config.loader);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SceneComponent, { data });
}
function SceneRenderer({
  ...
  const visible = status === "running" || status === "shutting_down" || status === "paused";
  const mounted = status === "running" || status === "shutting_down" || status === "paused" || status === "sleeping" || status === "preloading";
  if (!mounted) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("group", { visible, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SceneErrorBoundary, { name, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_react10.Suspense, { fallback: loadingFallback ?? null, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SceneContent, { entry }) }) }) }, name);
}
function SceneManager({
  ...
  const initializedRef = (0, import_react10.useRef)(false);
  ...
  const sceneEntries = (0, import_react10.useMemo)(() => {
    const entries = [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    children,
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SceneTransitionFlush, {}),
    sceneEntries.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      SceneRenderer,
      {
        entry,
        loadingFallback
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(TransitionOverlay, {}),
    persistent
  ] });
}
...
function Scene(props) {
  ...
  const configRef = (0, import_react11.useRef)({
    name,
    component,
    loader,
    transition,
  ...
  (0, import_react11.useEffect)(() => {
    useSceneStore.getState()._registerScene(configRef.current);
    return () => {
...
function getAssetManager() {
  if (!_instance8) _instance8 = new AssetManager();
  return _instance8;
}
...
function AssetLoader({
  ...
  const [progress, setProgress] = (0, import_react12.useState)(IDLE_PROGRESS);
  const [ready, setReady] = (0, import_react12.useState)(false);
  const startRef = (0, import_react12.useRef)(0);
  (0, import_react12.useEffect)(() => {
    const manager = getAssetManager();
    manager.configure({
      ...concurrency !== void 0 && { maxConcurrent: concurrency },
      ...retries !== void 0 && { retries },
      ...retryDelay !== void 0 && { retryDelay },
      ...timeout !== void 0 && { timeout }
    });
    if (typeof manifest === "string") {
      fetch(manifest).then((r) => r.json()).then((json) => startLoad(json)).catch((err) => {
        const errorProgress = {
          ...IDLE_PROGRESS,
          phase: "error",
          errors: [
    ...
    function startLoad(m) {
      ...
      for (const entry of entries) {
        const url = resolveUrl2(entry.url, baseUrl);
        const type = entry.type ?? detectAssetType(url);
        if (type === "gltf") {
          import_drei6.useGLTF.preload(
            url,
            entry.loaderOptions?.draco,
            entry.loaderOptions?.meshopt
          );
        }
        if (type === "texture") {
          import_drei6.useTexture.preload(url);
        }
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
    !ready && fallback && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_drei6.Html, { fullscreen: true, zIndexRange: [100, 0], children: typeof fallback === "function" ? fallback(progress) : fallback }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("group", { visible: ready, children })
  ] });
}
...
function LoadingScreen({
  ...
  injectKeyframes();
  const [tipIndex, setTipIndex] = (0, import_react13.useState)(0);
  ...
  if (theme === "custom" && children) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { ...S.root, background }, children: children(progress) });
  }
  const pct = Math.round(progress.progress * 100);
  const barWidth = `${progress.progress * 100}%`;
  const logoEl = logo ? typeof logo === "string" ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("img", { src: logo, alt: "", style: S.logo }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: S.logo, children: logo }) : null;
  if (theme === "minimal") {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { ...S.root, background }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { ...S.spinner, borderTopColor: accentColor } }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: S.pct, children: [
        pct,
        "%"
      ] })
    ] });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { ...S.root, background }, children: [
    ...
    showCurrentAsset && progress.currentAsset && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: S.asset, children: [
      "Loading ",
      progress.currentAsset,
      "..."
    ] }),
    showCount && progress.total > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: S.count, children: [
      progress.loaded,
      "/",
      progress.total
    ] }),
    isGaming && tips && tips.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: S.tip, children: tips[tipIndex] }),
    progress.errors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { ...S.count, color: "#ef4444", marginTop: 12 }, children: [
...
var ParticleEmitter = (0, import_react14.forwardRef)(
  function ParticleEmitter2({ preset, position, rotation, enabled = true, ...configOverrides }, ref) {
    const scene = (0, import_fiber7.useThree)((s) => s.scene);
    const groupRef = (0, import_react14.useRef)(null);
    const emitterIdRef = (0, import_react14.useRef)("");
    const configRef = (0, import_react14.useRef)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("group", { ref: setRefs, position, rotation });
  }
);
