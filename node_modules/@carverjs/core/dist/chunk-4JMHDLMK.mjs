...
var _posA = new Vector3();
var _posB = new Vector3();
...
import { createContext, useContext, useRef, Suspense, useState, useEffect } from "react";
...
function useRapierModules() {
  const [modules, setModules] = useState(_rapierModules);
  useEffect(() => {
    if (_rapierModules) {
...
function PhysicsGate({ config, mode, children }) {
  ...
  return /* @__PURE__ */ jsx(PhysicsContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsx(Suspense, { fallback: null, children: /* @__PURE__ */ jsx(
    Physics,
    {
      gravity,
      timeStep: timestep,
...
var RigidBodyRefContext = createContext(null);
...
function PhysicsBodyWrapper({
  ...
  return /* @__PURE__ */ jsx(RigidBody, { ref: rigidBodyRef, ...rigidBodyProps, children: /* @__PURE__ */ jsx(RigidBodyRefContext.Provider, { value: rigidBodyRef, children }) });
}
...
function getActorRegistry() {
  if (!_instance3) _instance3 = new ActorRegistry();
  return _instance3;
}
...
// src/systems/AudioManager.ts
var _emitterPos = new Vector32();
var _listenerPos = new Vector32();
var _listenerDir = new Vector32();
var _listenerUp = new Vector32();
...
function getAudioManager() {
  if (!_instance4) _instance4 = new AudioManager();
  return _instance4;
}
...
function getAssetManager() {
  if (!_instance5) _instance5 = new AssetManager();
  return _instance5;
}
...
function getTweenManager() {
  if (!_instance6) _instance6 = new TweenManager();
  return _instance6;
}
...
var _colorA = new Color();
var _colorB = new Color();
...
var EmitterInstance = class {
  constructor(config, mode) {
    ...
    this._tmpPosition = new Vector33();
    this._tmpQuaternion = new Quaternion();
    this._tmpScale = new Vector33();
    this._tmpColor = new Color();
    this._emitterPos = new Vector33();
    this._emitterQuat = new Quaternion();
...
function getParticleManager() {
  if (!_instance7) _instance7 = new ParticleManager();
  return _instance7;
}
...
//# sourceMappingURL=chunk-4JMHDLMK.mjs.map