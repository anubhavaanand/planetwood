...
__export(hooks_exports, {
  useActorRegistry: () => useActorRegistry,
  useAnimation: () => useAnimation,
  useAssetProgress: () => useAssetProgress,
  useAssets: () => useAssets,
  useAudio: () => useAudio,
  useCamera: () => useCamera,
  ...
  useGridCollision: () => useGridCollision,
  useInput: () => useInput,
  useParticles: () => useParticles,
  usePhysics: () => usePhysics,
  useScene: () => useScene,
  useSceneData: () => useSceneData,
  useSceneLifecycle: () => useSceneLifecycle,
  useSceneTransition: () => useSceneTransition,
  useTween: () => useTween
});
...
function useAnimation(clips, options = {}) {
  ...
  const { ref, mixer, actions, names } = (0, import_drei.useAnimations)(clips);
  const previousAction = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
    ...
    action.reset();
    action.setLoop(loop ? import_three.LoopRepeat : import_three.LoopOnce, loop ? Infinity : 1);
  ...
  const crossFadeTo = (0, import_react.useCallback)(
    (name, duration = 0.3) => {
      const action = actions[name];
      if (!action) return;
      if (previousAction.current) {
...
function useCamera(options = {}) {
  ...
  const _targetPos = (0, import_react2.useRef)(new import_three2.Vector3());
  const _desiredPos = (0, import_react2.useRef)(new import_three2.Vector3());
  const _lookAtPos = (0, import_react2.useRef)(new import_three2.Vector3());
  const shakeRef = (0, import_react2.useRef)({ active: false, intensity: 0, remaining: 0 });
  const transitionRef = (0, import_react2.useRef)(null);
  ...
  const shake = (0, import_react2.useCallback)((intensity = 0.3, duration = 0.3) => {
  ...
  const moveTo = (0, import_react2.useCallback)(
    (position, duration = 1) => {
      transitionRef.current = {
        ...
        to: new import_three2.Vector3(...position),
        duration,
        elapsed: 0
      };
    },
  ...
  const lookAtFn = (0, import_react2.useCallback)(
    (target) => {
      camera.lookAt(new import_three2.Vector3(...target));
    },
    [camera]
  );
...
function useGameLoop(callback, options = {}) {
  ...
  const accumulatorRef = (0, import_react3.useRef)(0);
  (0, import_fiber2.useFrame)((_, rawDelta) => {
...
function useInput(options = {}) {
  ...
  const actionsRef = (0, import_react4.useRef)(actions);
  (0, import_react4.useEffect)(() => {
    actionsRef.current = actions;
  }, [actions]);
  const isPressed = (0, import_react4.useCallback)((code) => {
    if (!enabledRef.current) return false;
    return getInputManager().getKey(code).pressed;
  }, []);
  const isJustPressed = (0, import_react4.useCallback)((code) => {
    if (!enabledRef.current) return false;
    return getInputManager().getKey(code).justPressed;
  }, []);
  const isJustReleased = (0, import_react4.useCallback)((code) => {
    if (!enabledRef.current) return false;
    return getInputManager().getKey(code).justReleased;
  }, []);
  const isAction = (0, import_react4.useCallback)((action) => {
    if (!enabledRef.current) return false;
  ...
  const isActionJustPressed = (0, import_react4.useCallback)((action) => {
    if (!enabledRef.current) return false;
    const bindings = actionsRef.current[action];
    if (!bindings) return false;
    const mgr = getInputManager();
  ...
  const getAxis = (0, import_react4.useCallback)((negative, positive) => {
  ...
  const pointer = (0, import_react4.useMemo)(() => getInputManager().getPointer(), []);
  return {
    isPressed,
    isJustPressed,
    isJustReleased,
...
var _posA = new import_three3.Vector3();
var _posB = new import_three3.Vector3();
...
function useCollision(options) {
  ...
  const onEnterRef = (0, import_react5.useRef)(onCollisionEnter);
  const onExitRef = (0, import_react5.useRef)(onCollisionExit);
  const onStayRef = (0, import_react5.useRef)(onCollisionStay);
  ...
  const returnRef = (0, import_react5.useRef)({
...
function useGridCollision(options) {
  ...
  const returnRef = (0, import_react6.useRef)({
...
var PhysicsContext = (0, import_react7.createContext)(null);
function usePhysicsContext() {
  return (0, import_react7.useContext)(PhysicsContext);
}
var RigidBodyRefContext = (0, import_react7.createContext)(null);
function useRigidBodyRef() {
  return (0, import_react7.useContext)(RigidBodyRefContext);
}
...
function usePhysics() {
  ...
  const returnRef = (0, import_react8.useRef)(null);
...
function useCameraDirection() {
  const { camera } = (0, import_fiber3.useThree)();
  const _dir = (0, import_react9.useRef)(new import_three4.Vector3());
  const getForward = (0, import_react9.useCallback)(() => {
    camera.getWorldDirection(_dir.current);
    _dir.current.y = 0;
    _dir.current.normalize();
    return [_dir.current.x, 0, _dir.current.z];
  }, [camera]);
  const getRight = (0, import_react9.useCallback)(() => {
    camera.getWorldDirection(_dir.current);
    _dir.current.y = 0;
    _dir.current.normalize();
...
// src/systems/AudioManager.ts
var _emitterPos = new import_three5.Vector3();
var _listenerPos = new import_three5.Vector3();
var _listenerDir = new import_three5.Vector3();
var _listenerUp = new import_three5.Vector3();
...
function useAudio(options = {}) {
  ...
  const enabledRef = (0, import_react10.useRef)(enabled);
  (0, import_react10.useEffect)(() => {
    enabledRef.current = enabled;
  }, [enabled]);
  const initialSoundsRef = (0, import_react10.useRef)(sounds);
  (0, import_react10.useEffect)(() => {
  ...
  (0, import_react10.useSyncExternalStore)(mgr.subscribe, mgr.getSnapshot);
  const play = (0, import_react10.useCallback)((name, opts) => {
    if (!enabledRef.current) return null;
    return getAudioManager().play(name, opts);
  }, []);
  const stop = (0, import_react10.useCallback)((name) => {
    getAudioManager().stopByName(name);
  }, []);
  const pause = (0, import_react10.useCallback)((name) => {
    getAudioManager().pauseByName(name);
  }, []);
  const resume = (0, import_react10.useCallback)((name) => {
    getAudioManager().resumeByName(name);
  }, []);
  const isPlaying = (0, import_react10.useCallback)((name) => {
    return getAudioManager().isSoundPlaying(name);
  }, []);
  const playMusic = (0, import_react10.useCallback)((src, opts) => {
    if (!enabledRef.current) return;
    getAudioManager().playMusic(src, opts);
  }, []);
  const stopMusic = (0, import_react10.useCallback)((fadeOut) => {
    getAudioManager().stopMusic(fadeOut);
  }, []);
  const pauseMusic = (0, import_react10.useCallback)(() => {
    getAudioManager().pauseMusic();
  }, []);
  const resumeMusic = (0, import_react10.useCallback)(() => {
    getAudioManager().resumeMusic();
  }, []);
  const isMusicPlaying = (0, import_react10.useCallback)(() => {
    return getAudioManager().isMusicPlaying();
  }, []);
  const setVolume = (0, import_react10.useCallback)((channel, volume) => {
    getAudioManager().setChannelVolume(channel, volume);
  }, []);
  const getVolume = (0, import_react10.useCallback)((channel) => {
    return getAudioManager().getChannelVolume(channel);
  }, []);
  const setMute = (0, import_react10.useCallback)((channel, muted) => {
    getAudioManager().setChannelMute(channel, muted);
  }, []);
  const isMuted = (0, import_react10.useCallback)((channel) => {
    return getAudioManager().isChannelMuted(channel);
  }, []);
  const setMasterMute = (0, import_react10.useCallback)((muted) => {
    getAudioManager().setMasterMute(muted);
  }, []);
  const preload = (0, import_react10.useCallback)(async (name) => {
    await getAudioManager().preload(name);
  }, []);
  const preloadAll = (0, import_react10.useCallback)(async (names) => {
...
function useScene() {
  ...
  const go = (0, import_react11.useCallback)(
    (name, data, transition) => {
      useSceneStore.getState().go(name, data, transition);
    },
    []
  );
  const push = (0, import_react11.useCallback)(
    (name, data, transition) => {
      useSceneStore.getState().push(name, data, transition);
    },
    []
  );
  const pop = (0, import_react11.useCallback)((transition) => {
    useSceneStore.getState().pop(transition);
  }, []);
  const replace = (0, import_react11.useCallback)(
    (name, data, transition) => {
...
function useSceneData() {
  ...
  const setShared = (0, import_react11.useCallback)((key, value) => {
    useSceneStore.getState().setShared(key, value);
  }, []);
  const getShared = (0, import_react11.useCallback)((key) => {
...
function useSceneLifecycle(sceneName, callbacks) {
  const callbacksRef = (0, import_react11.useRef)(callbacks);
  (0, import_react11.useEffect)(() => {
    callbacksRef.current = callbacks;
  });
  const prevStatusRef = (0, import_react11.useRef)(null);
...
function getAssetManager() {
  if (!_instance6) _instance6 = new AssetManager();
  return _instance6;
}
...
function useAssets(keyOrKeys) {
  ...
  const keysRef = (0, import_react12.useRef)(keyOrKeys);
...
function useAssetProgress() {
  const manager = getAssetManager();
  (0, import_react13.useSyncExternalStore)(manager.subscribe, manager.getSnapshot);
...
function getTweenManager() {
  if (!_instance7) _instance7 = new TweenManager();
  return _instance7;
}

// src/hooks/useTween.ts
function useTween() {
  const ownedIdsRef = (0, import_react14.useRef)(/* @__PURE__ */ new Set());
  ...
  const tween = (0, import_react14.useCallback)(
    (config) => {
  ...
  const tweenNumber = (0, import_react14.useCallback)(
    (config) => {
  ...
  const timeline = (0, import_react14.useCallback)(
    (config) => {
      return getTweenManager().createTimeline(config);
    },
    []
  );
  const killAll = (0, import_react14.useCallback)(() => {
    const mgr = getTweenManager();
    for (const id of ownedIdsRef.current) {
      mgr.killById(id);
    }
  ...
  const pauseAll = (0, import_react14.useCallback)(() => {
    getTweenManager().pauseAll();
  }, []);
  const resumeAll = (0, import_react14.useCallback)(() => {
    getTweenManager().resumeAll();
  }, []);
  const returnRef = (0, import_react14.useRef)({
    tween: null,
    tweenNumber: null,
    timeline: null,
    killAll: null,
...
var _textureLoader = new import_three6.TextureLoader();
function sampleValueRange(range) {
  if (typeof range === "number") return range;
  return range[0] + Math.random() * (range[1] - range[0]);
}
var _colorA = new import_three6.Color();
var _colorB = new import_three6.Color();
...
function resolveBlending(mode) {
  switch (mode) {
    case "additive":
      return { blending: import_three6.AdditiveBlending };
    case "multiply":
      return { blending: import_three6.MultiplyBlending };
    case "screen":
      return {
        blending: import_three6.CustomBlending,
        blendSrc: import_three6.OneFactor,
        blendDst: import_three6.OneMinusSrcColorFactor
      };
    default:
      return { blending: import_three6.NormalBlending };
  }
}
...
var EmitterInstance = class {
  constructor(config, mode) {
    ...
    this._tmpMatrix = new import_three6.Matrix4();
    this._tmpPosition = new import_three6.Vector3();
    this._tmpQuaternion = new import_three6.Quaternion();
    this._tmpScale = new import_three6.Vector3();
    this._tmpColor = new import_three6.Color();
    this._emitterPos = new import_three6.Vector3();
    this._emitterQuat = new import_three6.Quaternion();
    ...
    this._material = new import_three6.RawShaderMaterial({
      uniforms: {
      ...
      transparent: true,
      depthWrite: false,
      side: import_three6.DoubleSide,
      ...blendConfig
    });
    this.mesh = new import_three6.InstancedMesh(geometry, this._material, this._maxParticles);
    this.mesh.count = 0;
    ...
    this._alphaAttr = new import_three6.InstancedBufferAttribute(this._alphaArray, 1);
    this._spriteFrameAttr = new import_three6.InstancedBufferAttribute(
      this._spriteFrameArray,
      1
    );
    this._rotationAttr = new import_three6.InstancedBufferAttribute(this._rotationArray, 1);
...
function getParticleManager() {
  if (!_instance8) _instance8 = new ParticleManager();
  return _instance8;
}
...
function useParticles(options) {
  ...
  const scene = (0, import_fiber4.useThree)((s) => s.scene);
  const emitterIdRef = (0, import_react15.useRef)("");
  const sourceRef = (0, import_react15.useRef)(null);
  const configRef = (0, import_react15.useRef)(null);
  ...
  const burst = (0, import_react15.useCallback)((count) => {
  ...
  const stop = (0, import_react15.useCallback)(() => {
  ...
  const setRate = (0, import_react15.useCallback)((rate) => {
    getParticleManager().getEmitter(emitterIdRef.current)?.setRate(rate);
  }, []);
  const getActiveCount = (0, import_react15.useCallback)(() => {
    return getParticleManager().getEmitter(emitterIdRef.current)?.getActiveCount() ?? 0;
  }, []);
  const isEmitting = (0, import_react15.useCallback)(() => {
  ...
  const returnRef = (0, import_react15.useRef)({
    ref: sourceRef,
    burst: null,
    start: null,
    stop: null,
