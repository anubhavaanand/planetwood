...
import { W as WorldMode, A as AmbientLightProps, D as DirectionalLightProps, a as SkyProps, E as EnvironmentProps, C as CameraProps2D, b as CameraProps3D, O as OrbitControlsProps, c as WorldPhysicsConfig, d as ActorTransformProps, e as ActorEventProps, f as ActorPhysicsProps, P as PrimitiveShape, g as PrimitiveMaterialType, h as CameraType, i as CameraControlsType, j as CameraFollowConfig, k as PerspectiveCameraProps, l as OrthographicCameraProps, M as MapControlsProps, m as PointerLockControlsProps, U as UseCameraReturn, n as SceneConfig } from './scene-Dl2UZ826.js';
import * as three from 'three';
import { ColorRepresentation, Group, OrthographicCamera, PerspectiveCamera } from 'three';
import * as React$1 from 'react';
import React__default, { ReactNode } from 'react';
import { SpriteAnimatorProps } from '@react-three/drei';
import { N as NetworkedConfig, A as AudioListenerConfig, a as AssetManifest, b as AssetEntry, L as LoadingProgress, c as AssetLoadError, P as ParticleEmitterProps } from './particles-3P2V9bLu.js';

interface GameProps extends Omit<CanvasProps, "camera"> {
...
declare function Game({ mode, ambientLightProps, directionalLightProps, skyProps, environmentProps, children, ...canvasProps }: GameProps): react_jsx_runtime.JSX.Element;
...
declare function World({ cameraProps2D, cameraProps3D, orbitControlsProps, physics, active, children, }: WorldProps): react_jsx_runtime.JSX.Element;

interface GameContextValue {
    mode: WorldMode;
}
declare function useGameContext(): GameContextValue;
...
interface ModelActorProps extends ActorBaseProps {
    type: "model";
    src: string;
...
interface SpriteActorProps extends ActorBaseProps {
    type: "sprite";
    src: string;
    atlasUrl?: string;
    billboard?: boolean;
    ...
    spriteAnimation?: Partial<Pick<SpriteAnimatorProps, "startFrame" | "endFrame" | "fps" | "frameName" | "loop" | "numberOfFrames" | "autoPlay" | "play" | "pause" | "flipX" | "alphaTest" | "playBackwards" | "resetOnEnd" | "animationNames" | "onStart" | "onEnd" | "onLoopEnd" | "onFrame">>;
}
interface PrimitiveActorProps extends ActorBaseProps {
    type: "primitive";
...
type ActorProps = ModelActorProps | SpriteActorProps | PrimitiveActorProps;
declare const Actor: React__default.ForwardRefExoticComponent<ActorProps & React__default.RefAttributes<Group<three.Object3DEventMap>>>;
...
declare const Camera: React$1.ForwardRefExoticComponent<CameraProps & React$1.RefAttributes<OrthographicCamera | PerspectiveCamera>>;
 ...
 */
declare function AudioListener({ listenerRef }: AudioListenerConfig): null;
...
interface SceneManagerProps {
    ...
    persistent?: React__default.ReactNode;
    /** <Scene> components for registration */
    children: React__default.ReactNode;
}
declare function SceneManager({ initial, loadingFallback, persistent, children, }: SceneManagerProps): react_jsx_runtime.JSX.Element;

interface SceneProps<TData = unknown> extends SceneConfig<TData> {
}
/**
 ...
 */
declare function Scene<TData = unknown>(props: SceneProps<TData>): null;
 ...
 *   </AssetLoader>
 */
declare function AssetLoader({ manifest, fallback, concurrency, retries, retryDelay, timeout, minLoadTime, onComplete, onError, onProgress, children, }: AssetLoaderProps): react_jsx_runtime.JSX.Element;
 ...
 *   </AssetLoader>
 */
declare function LoadingScreen({ progress, theme, background, accentColor, logo, tips, tipInterval, showCurrentAsset, showCount, children, }: LoadingScreenProps): react_jsx_runtime.JSX.Element;

declare const ParticleEmitter: React$1.ForwardRefExoticComponent<ParticleEmitterProps & React$1.RefAttributes<Group<three.Object3DEventMap>>>;

export { Actor, type ActorProps, AssetLoader, type AssetLoaderProps, AudioListener, AudioListenerConfig, Camera, type CameraProps, Game, type GameProps, LoadingScreen, type LoadingScreenProps, type ModelActorProps, ParticleEmitter, ParticleEmitterProps, type PrimitiveActorProps, Scene, SceneManager, type SceneManagerProps, type SceneProps, type SpriteActorProps, World, type WorldProps, useGameContext };
